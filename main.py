...
def main():
    ...
    app.add_handler(CommandHandler("xlsxtotxt",                         light_rate_limiter(cmd_xlsxtotxt)))
    app.add_handler(CommandHandler("merge",                             light_rate_limiter(cmd_merge)))
    app.add_handler(CommandHandler("vcftotxt",                          light_rate_limiter(cmd_vcftotxt)))
    app.add_handler(CommandHandler("pecahvcf",                          light_rate_limiter(cmd_pecahvcf)))
    app.add_handler(CommandHandler("pecahtxt",                          light_rate_limiter(cmd_pecahtxt)))
    app.add_handler(CommandHandler("rename",                            light_rate_limiter(cmd_rename)))
    app.add_handler(CommandHandler("count",                             light_rate_limiter(cmd_count)))
    app.add_handler(CommandHandler("duplikat",                          light_rate_limiter(cmd_duplikat)))
    app.add_handler(CommandHandler("walink",                            light_rate_limiter(cmd_walink)))
    app.add_handler(CommandHandler("walinkweb",                         light_rate_limiter(cmd_walinkweb)))
    app.add_handler(CommandHandler("cleanup",                           light_rate_limiter(cmd_cleanup)))
    app.add_handler(CommandHandler("manual",                            light_rate_limiter(cmd_manual)))
    ...
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_ttv_style_callback), pattern="^ttv_style_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_ttv_numstyle_callback), pattern="^ttv_numstyle_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_ttv_delivery_callback), pattern="^ttv_deliv_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_xtv_style_callback), pattern="^xtv_style_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_xtv_numstyle_callback), pattern="^xtv_numstyle_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_xtv_delivery_callback), pattern="^xtv_deliv_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_v2t_delivery_callback), pattern="^v2t_deliv_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_pecahtxt_delivery_callback), pattern="^pecahtxt_deliv_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_pecahvcf_delivery_callback), pattern="^pecahvcf_deliv_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_duplikat_help_callback), pattern="^show_duplikat_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_rename_numstyle_callback), pattern="^rename_numstyle_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_rename_delivery_callback), pattern="^rename_deliv_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_count_help_callback), pattern="^show_count_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_txttovcf_help_callback), pattern="^show_txttovcf_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_vcfsimple_help_callback), pattern="^show_vcfsimple_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_xlsxtovcf_help_callback), pattern="^show_xlsxtovcf_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_vcftotxt_help_callback), pattern="^show_vcftotxt_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_xlsxtotxt_help_callback), pattern="^show_xlsxtotxt_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_merge_help_callback), pattern="^show_merge_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_pecahvcf_help_callback), pattern="^show_pecahvcf_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_pecahtxt_help_callback), pattern="^show_pecahtxt_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_rename_help_callback), pattern="^show_rename_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_walink_help_callback), pattern="^show_walink_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_walinkweb_help_callback), pattern="^show_walinkweb_help$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_cleanup_help_callback), pattern="^show_cleanup_help$"))
    ...
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_addnum_numbers_done_callback), pattern="^addnum_numbers_done$"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_addnum_label_callback), pattern="^addnum_lbl_"))
    app.add_handler(CallbackQueryHandler(light_rate_limiter(handle_show_addnum_help_callback), pattern="^show_addnum_help$"))
    ...
    app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, light_rate_limiter(text_router)))
