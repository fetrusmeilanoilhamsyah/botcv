...
SEND_BATCH_SIZE  = 1     # kirim N file lalu napas
SEND_BATCH_DELAY = 0.1   # detik napas setelah tiap batch
SEND_FILE_DELAY  = 0.08  # detik jeda antar file dalam batch ini kernder tapi 
